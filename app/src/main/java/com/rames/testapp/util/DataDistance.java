...
public class DataDistance {
    ...
    /**
     * 两个时间相差距离多少天多少小时多少分多少秒
     * @param smallTime 时间参数1(小) 时间戳
     * @param bigTime 时间参数2(大) 格式：2009-01-01 12:00:00
     * @return String 返回值为：xx天xx小时xx分xx秒
     */
    public static String getDistanceTime(long smallTime, long bigTime) {
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
